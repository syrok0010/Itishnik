...
namespace Itishnik.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250611135103_RemoveGradeFromTaskBlock")]
    partial class RemoveGradeFromTaskBlock
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Itishnik.Domain.Entities.Task", b =>
                {
                    ...
                    b.Property<string>("ReferenceSolutionText")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Itishnik.Domain.Entities.TaskBlockEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Itishnik.Domain.Entities.TaskBlockEntry", b =>
                {
                    b.HasOne("Itishnik.Domain.Entities.TaskBlock", "TaskBlock")
                        .WithMany("TasksEntries")
                        .HasForeignKey("TaskBlockId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Itishnik.Domain.Entities.Task", "Task")
                        .WithMany("TaskBlockEntries")
                        .HasForeignKey("TaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
