...
export class UsersClient implements IUsersClient {
    ...
    changePassword(oldPassword: string, newPassword: string): Observable<void> {
        ...
        if (oldPassword === undefined || oldPassword === null)
            throw new Error("The parameter 'oldPassword' must be defined and cannot be null.");
        else
            url_ += "oldPassword=" + encodeURIComponent("" + oldPassword) + "&";
        if (newPassword === undefined || newPassword === null)
            throw new Error("The parameter 'newPassword' must be defined and cannot be null.");
        else
